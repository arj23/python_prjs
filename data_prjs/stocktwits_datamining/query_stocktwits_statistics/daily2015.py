...
def main():
    ...
    date_list = []
    count_list = []
    while datetime.datetime(2015,1,1,0,0,0) < start_datetime :
    ...
    results_collection.insert({'2015_daily_Mean': mean_msg_count, '2015_daily_min': min_msg_count, '2015_daily_max': max_msg_count, '2015_all_count': all_msg_count})
    std_dev = numpy.std(count_list)
    results_collection.insert({'2015_std_dev': std_dev})



    # end_time = datetime.datetime(2015,11,2,23,59,59)
    # start_datetime = end_time - datetime.timedelta(minutes=30)
    # count_list_30min = []
    # date_list_30min = []
    # while datetime.datetime(2015,10,22,0,0,0) < start_datetime :
    #     result_curser = msgs_collection.find({'created_at': {'$lt': end_time, '$gte': start_datetime}})
    #     count = result_curser.count();
    #     end_time = start_datetime
    ...
    # 
    # append_df_to_excel("2015_30min.xlsx", df)
